...
var step;
if(HH<=0)step="凌晨";
else if(HH<=1)step="月黑";
else if(HH<=2)step="防盗";
else if(HH<=3)step="夜深";
else if(HH<=4)step="鸡叫";
else if(HH<=5)step="清晨";
else if(HH<=6)step="起床";
else if(HH<=7)step="晨练";
else if(HH<=8)step="早餐";
else if(HH<=9)step="奋斗";
else if(HH<=10)step="振作";
else if(HH<=11)step="精神";
else if(HH<=12)step="午饭";
else if(HH<=13)step="午休";
else if(HH<=14)step="奋斗";
else if(HH<=15)step="振作";
else if(HH<=16)step="精神";
else if(HH<=17)step="放松";
else if(HH<=18)step="晚饭";
else if(HH<=19)step="新闻";
else if(HH<=20)step="洗漱";
else if(HH<=21)step="上床";
else if(HH<=22)step="晚安";
else if(HH<=23)step="睡吧";
clock=clock+''+step;
return(clock);
}
